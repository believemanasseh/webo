		...
		<Layout>
			<StyledPage>
				...
				<div className='followers-list'>
					<img className='profile-pic' src={black} alt='profile-pic' height={50} width={50} />
					<div className='follower'>
						...
						<p className='bio'>
							Finance Professional || Data Analyst || Avid Reader. Mediocrity is not an option
							for me. The world is my Oyster..
						</p>
					</div>
				</div>
			</StyledPage>
